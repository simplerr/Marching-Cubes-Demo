...
void MarchingCubes::InitNoiseJob(Vk::Device* device)
{
	...
	effectDesc.shaderDesc.computeShaderPath = "shaders/generate_noise.comp";
...
{
	Vk::EffectCreateInfo effectDesc;
	effectDesc.shaderDesc.computeShaderPath = "shaders/terrain_brush.comp";
...
{
	Vk::EffectCreateInfo effectDesc;
	effectDesc.shaderDesc.computeShaderPath = "shaders/marching_cubes.comp";
...
void MarchingCubes::InitTerrainJob(Vk::Device* device, uint32_t width, uint32_t height)
{
	...
	Vk::EffectCreateInfo effectDesc;
	effectDesc.shaderDesc.vertexShaderPath = "shaders/terrain.vert";
	effectDesc.shaderDesc.fragmentShaderPath = "shaders/terrain.frag";
...
{
	Vk::EffectCreateInfo effectDesc;
	effectDesc.shaderDesc.computeShaderPath = "shaders/terrain_intersection.comp";
